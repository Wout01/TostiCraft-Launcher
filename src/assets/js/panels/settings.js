...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Use the version of java delivered with the launcher';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Use the version of java delivered with the launcher';
            file.value = '';
